            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a href="/change_password" className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Esqueceu sua senha?</a>
                </div>
                ...
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                  Ainda não possui uma conta? <a href="/register" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Cadastra-se</a>
                </p>
              </form>
            </div>
          </div>
