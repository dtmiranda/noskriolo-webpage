...
const Footer = () => {
  return (
    <footer className="p-4 bg-black opacity-90 sm:p-6 dark:bg-gray-800">
      <div className="pt-20 mx-auto max-w-screen-xl">
        <div className="pb-10 md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="/" className="flex items-center">
              <img src="/logo.svg" className="mr-3 h-8 rounded-lg" alt="Nos kriolo logo" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Nos Kriolo</span>
            </a>
            <p className='text-white dark:text-gray-400 my-4'>Na essência do Kriolu, nossa língua única materna, encontra-se a pulsação da nossa cultura.</p>
            <div className="flex mt-4 space-x-6 justify-start sm:mt-0">
